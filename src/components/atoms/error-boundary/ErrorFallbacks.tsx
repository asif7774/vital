  ...
  <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
    <div className="max-w-md w-full text-center">
      <div className="mx-auto h-16 w-16 bg-red-100 rounded-full flex items-center justify-center mb-6">
        <span className="text-red-600 text-3xl" aria-hidden="true">
          !
        </span>
      </div>
  ...
  <div className="min-h-[60vh] flex flex-col items-center justify-center px-4">
    <div className="max-w-md w-full text-center">
      <div className="mx-auto h-12 w-12 bg-yellow-100 rounded-full flex items-center justify-center mb-4">
        <span className="text-yellow-600 text-2xl" aria-hidden="true">
          ⚠
        </span>
      </div>
      <h2 className="text-xl font-bold text-gray-900 mb-2">Page Load Error</h2>
      <p className="text-gray-600 mb-4">
        This page couldn&apos;t be loaded. Please try again or navigate to a
        different page.
      </p>
      {import.meta.env.DEV && (
